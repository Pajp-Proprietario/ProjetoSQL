...
create or replace package body pk_funcionario  as
    /*5 - Escreva um procedimento que insira um novo funcionário na tabela de funcionários, garantindo que o novo funcionário tenha um número de identificação único e válido. <alterado>*/
